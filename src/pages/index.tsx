    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow container-custom py-12">
        <section className="mb-16">
          <h2 className="text-4xl font-bold mb-6">Hello, I'm <span className="text-primary">Your Name</span></h2>
          <p className="text-xl mb-8">Full-stack Developer specializing in modern web technologies</p>
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
          <div className="bg-white p-6 rounded-lg shadow dark:bg-gray-800">
            ...
            <p>I'm a passionate developer with experience in React, TypeScript, and Next.js. 
               I love creating beautiful, responsive, and user-friendly web applications.</p>
          </div>
